...
function showRandomImageAtStart() {
    ...
    function getRandomLink(links) {
        // "|" for a kinda "int div"
        return links[Math.floor(links.length * Math.random() | 0)];
    }
    ...
    // done: Implement switchFullImage() below.

    // TODO: Call switchFullImage() with the URL of the random image and the alt attribute of the thumbnail
